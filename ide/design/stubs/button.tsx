/**
 * Copied verbatim from Orca (src/renderer/src/components/ui/button.tsx, MIT,
 * (c) Lovecast Inc.) so the harness renders the real button, not a lookalike.
 * Refresh it from the checkout if upstream changes; nothing here edits it.
 */
